...
const SidebarProvider = ({
  ...
  const discussionStorageEmpty = localStorage.getItem('showDiscussionSidebar') === null;
  const showDiscussionSidebar = discussionStorageEmpty ? true : localStorage.getItem('showDiscussionSidebar') === 'true';
